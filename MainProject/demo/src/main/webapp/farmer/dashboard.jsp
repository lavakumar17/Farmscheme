            ...
            <div class="d-md-flex justify-content-center pb-5">
              ...
              <div class="col-md-4 col-xl-4">
                <div class="card bg-warning order-card">
                  ...
                  <a class="btn btn-warning" href="javascript:document.soldHistory.submit()" role="button"><h3>View Sold History</h3></a>
                  <form name="soldHistory" action="/farmer/soldHistory" hidden="true" method="post">
      				<input hidden type="submit" value=""/></form>
                </div>
              </div>
              ...
              <div class="col-md-4 col-xl-4">
                <div class="card bg-success order-card">
                  ...
                  <a class="btn btn-success text-dark" href="javascript:document.marketPlace.submit()" role="button"><h3>View Market Place</h3></a>
                  <form name="marketPlace" action="/farmer/market_place" hidden="true" method="get">
      				<input hidden type="submit" value=""/></form>
                </div>
              </div>
            </div>
            ...
            <div class="d-md-flex justify-content-center pb-5">
              <div class="col-md-4 col-xl-4">
                <div class="card bg-secondary order-card">
                  ...
                  <form name="insuranceForm" action="/farmer/insurance" hidden="true" method="get">
      				<input hidden type="submit" value=""/></form>
                </div>
              </div>
