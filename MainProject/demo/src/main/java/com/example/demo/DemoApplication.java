...
import com.example.demo.farm_scheme.controllers.BidAmountController;
...
import com.example.demo.farm_scheme.controllers.InsuranceClaimController;
...
import com.example.demo.farm_scheme.controllers.SoldHistoryController;
...
public class DemoApplication {
	...
	@RequestMapping("/farmer/soldHistory")
	public SoldHistoryController soldHistory() {
		return new SoldHistoryController();
	}
	@RequestMapping("/bidder/bidAmount")
	public BidAmountController bidAmount() {
		return new BidAmountController();
	}
	@RequestMapping("/farmer/insurance")
	public ModelAndView insurance() {
		return new ModelAndView("/farmer/insurance.jsp");
	}
	@RequestMapping("/farmer/insuranceClaim")
	public InsuranceClaimController farmerInsuranceClaim() {
		return new InsuranceClaimController();
	}
}
