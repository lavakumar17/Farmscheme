        ...
        <div class="col-12 col-md-9 col-lg-7 col-xl-6 bg-secondary">
          <div class="card" style="border-radius: 15px;">
           <div class="card-body p-5">
              ...
              <form action="/farmer/registration" method="post">
                ...
                <div class="form-outline mb-4">
                <h5 class="text-center">Land Details</h5>
                    <label class="form-label" for="form3Example4cdg">Area</label>
                    <input type="text" id="form3Example4cdg" class="form-control form-control-lg" name="area" required />
                </div>
                ...
                <div class="form-outline mb-4">
                    <label class="form-label" for="form3Example4cdg">Pin Code</label>
                    <input type="text" id="form3Example4cdg" class="form-control form-control-lg" name="pin_code" required />
                </div>
                ...
                <div class="form-outline mb-4">
                    <label class="form-label" for="form3Example4cdg">Certificate</label>
                    <input type="text" id="form3Example4cdg" class="form-control form-control-lg" name="certificate" required />
                </div>
                ...
                <p class="text-center text-muted mt-5 mb-0">Have already an account? <a href="/farmer/"
