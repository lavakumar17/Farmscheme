      ...
      <div class="container">
        <div class="d-sm-flex">
          <div>
            ...
            <br />
              <a class="btn btn-primary btn-lg" onclick="javascript:document.bidderDashBoardForm.submit()" name="submit">BIDDER LOGIN</a>
              <form name="bidderDashBoardForm" action="/bidder/dashboard.jsp" method="post" hidden="true">
      				<input hidden type="submit" value="/bidder/dashboard.jsp" />
			</form>
          </div>
          <img
