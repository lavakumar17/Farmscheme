      ...
      <div class="container">
        <div class="d-sm-flex">
          <div>
            ...
            <br />
              <a class="btn btn-primary btn-lg" onclick="javascript:document.adminDashBoardForm.submit()" name="submit">ADMIN LOGIN</a>
              <form name="adminDashBoardForm" action="/admin/dashboard.jsp" method="post" hidden="true">
      				<input hidden type="submit" value="/admin/dashboard.jsp" />
			</form>
          </div>
          <img
