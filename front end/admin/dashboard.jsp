    ...
    <div id="wrapper" class="toggled">
        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
                ...
                <li>
                    <a href="javascript:document.bookRoomForm.submit()">Check Farmer Docs</a>
              ...
              <div class="col-md-4 col-xl-4">
                <div class="card bg-info order-card">
                  <div class="card-block d-none d-md-block">
                    <i class="fas fa-file p-5 pb-1 fa-3x text-center w-100"></i>
                  </div>
                  <a class="btn btn-info" href="javascript:document.addCustomerForm.submit()" role="button"><h3>Validate Farmer Docs</h3></a>
            ...
            <div class="d-md-flex justify-content-center pb-5">
              <div class="col-md-4 col-xl-4">
                <div class="card bg-secondary order-card">
                  ...
                  <a class="btn btn-secondary text-dark" href="javascript:document.addServicesForm.submit()" role="button"><h3>Insurance Claim Request</h3></a>
              ...
              <div class="col-md-4 col-xl-4">
                <div class="card bg-danger order-card">
                  ...
                  <a class="btn btn-danger text-dark" href="javascript:document.checkOutForm.submit()" role="button"><h3>Change Bid Status</h3></a>
